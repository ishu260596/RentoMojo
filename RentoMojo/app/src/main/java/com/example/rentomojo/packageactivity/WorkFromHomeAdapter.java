...
public class WorkFromHomeAdapter extends RecyclerView.Adapter<WorkFromHomeAdapter.ItemViewHolder> {

    List<ExplorePackageModel> explorePackageModelList;

    public WorkFromHomeAdapter(List<ExplorePackageModel> explorePackageModelList) {
        this.explorePackageModelList=explorePackageModelList;
    }

    @NonNull
    @Override
    public WorkFromHomeAdapter.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.explore_package_item_layout, parent, false);
        return new WorkFromHomeAdapter.ItemViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull WorkFromHomeAdapter.ItemViewHolder holder, int position) {
