...
public class CategoryViewHolderAdapterTwo extends RecyclerView.Adapter<CategoryViewHolderAdapterTwo.ItemViewHolder> {
    List<CategoryItem> categoryItemList;

    public CategoryViewHolderAdapterTwo( List<CategoryItem> categoryItemList) {
        this.categoryItemList=categoryItemList;
    }

    @NonNull
    @Override
    public CategoryViewHolderAdapterTwo.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_layout_category, parent, false);
        return new CategoryViewHolderAdapterTwo.ItemViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CategoryViewHolderAdapterTwo.ItemViewHolder holder, int position) {
