...
public class ElectronicsAdapter extends RecyclerView.Adapter<ElectronicsAdapter.ItemViewHolder>{

    List<PackageItem> packageItemList;

    public ElectronicsAdapter(List<PackageItem> packageItemList) {
        this.packageItemList = packageItemList;
    }

    @NonNull
    @Override
    public ElectronicsAdapter.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.package_item_layout, parent, false);
        return new ElectronicsAdapter.ItemViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ElectronicsAdapter.ItemViewHolder holder, int position) {
