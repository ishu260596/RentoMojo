...
public class OneBhkFragment extends Fragment implements BuyItemClickListner{
    ...
    private void buildRecyclerViewData_9() {
        ...
        BedroomAdapter adapterOne = new BedroomAdapter(explorePackageModelList_9,this);
