...
public class LivingRoomAdapter extends RecyclerView.Adapter<LivingRoomAdapter.ItemViewHolder>{
    ...
    @NonNull
    @Override
    public LivingRoomAdapter.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.explore_package_item_layout, parent, false);
        return new LivingRoomAdapter.ItemViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull LivingRoomAdapter.ItemViewHolder holder, int position) {
