...
public class ApplianceFragment extends Fragment implements BuyItemClickListner {
    ...
    private void buildRecyclerViewData_3() {
        ...
        BedroomAdapter adapterOne = new BedroomAdapter(explorePackageModelList_3,this);
