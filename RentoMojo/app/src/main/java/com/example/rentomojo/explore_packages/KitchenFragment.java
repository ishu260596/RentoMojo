...
public class KitchenFragment extends Fragment implements BuyItemClickListner{
    ...
    private void buildRecyclerViewData_5() {
        ...
        BedroomAdapter adapterOne = new BedroomAdapter(explorePackageModelList_5,this);
