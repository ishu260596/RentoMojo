...
public class FitnessAndExerciseAdapter extends RecyclerView.Adapter<FitnessAndExerciseAdapter.ItemViewHolder>{

    List<ExplorePackageModel> explorePackageModelList;

    public FitnessAndExerciseAdapter(List<ExplorePackageModel> explorePackageModelList) {
        this.explorePackageModelList=explorePackageModelList;
    }

    @NonNull
    @Override
    public FitnessAndExerciseAdapter.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.explore_package_item_layout, parent, false);
        return new FitnessAndExerciseAdapter.ItemViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FitnessAndExerciseAdapter.ItemViewHolder holder, int position) {
